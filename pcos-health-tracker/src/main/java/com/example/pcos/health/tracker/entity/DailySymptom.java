...
public class DailySymptom {
    ...
    public Integer getCramps() { return cramps; }
    public void setCramps(Integer cramps) { this.cramps = cramps; }

    public Integer getAcne() { return acne; }
    public void setAcne(Integer acne) { this.acne = acne; }
    ...
    public void setBloating(Integer bloating) { this.bloating = bloating; }
